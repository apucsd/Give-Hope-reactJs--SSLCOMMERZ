...
const Footer = () => {
  return (
    <footer className="">
      <div className="mx-auto grid max-w-screen-xl gap-y-8 gap-x-12 px-4 py-10 sm:px-20 grid-cols-2  xl:grid-cols-4 xl:px-10">
        ...
        <div className="">
          <div className="mt-4 mb-2 font-medium xl:mb-4">Support Us</div>
          <div className="">
            <div className="mb-4 ">
              <a
              ...
              >
                <div className="border border-[#FF6154]  p-4 rounded-md text-center text-[#FF6154] uppercase">
                  <ul className="flex md:flex-row flex-col flex-wrap justify-center items-center gap-6">
                    <li>
